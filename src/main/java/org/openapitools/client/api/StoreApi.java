...
public class StoreApi {
     ...
     */
    public okhttp3.Call deleteOrderCall(@javax.annotation.Nonnull Long orderId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteOrderValidateBeforeCall(@javax.annotation.Nonnull Long orderId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteOrderWithHttpInfo(@javax.annotation.Nonnull Long orderId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteOrderAsync(@javax.annotation.Nonnull Long orderId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @param order Order object that needs to be added to the store (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details

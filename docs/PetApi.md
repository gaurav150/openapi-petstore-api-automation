...
public class Example {
  public static void main(String[] args) {
    ...
    PetApi apiInstance = new PetApi(defaultClient);
    Pet pet = new Pet(); // Pet | Pet object that needs to be updated
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **pet** | [**Pet**](Pet.md)| Pet object that needs to be updated | |
...
Updates a pet&#39;s name and status using form parameters.
